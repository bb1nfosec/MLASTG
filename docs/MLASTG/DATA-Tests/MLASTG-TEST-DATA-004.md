...
## Control Reference
**Controls Tested:** MLASVS-DATA-003 (Data Access Control Enforcement), MLASVS-DATA-007 (Secure Data Storage), MLASVS-DATA-008 (Data Encryption at Rest), MLASVS-DATA-009 (Data Encryption in Transit), MLASVS-DATA-012 (Data Retention Policy), MLASVS-DATA-021 (Federated Data Governance — L2), MLASVS-DATA-027 (Data Usage Auditing — L2), MLASVS-DATA-028 (Cross-Border Data Compliance — L2)
...
5. **Fail if:** Any data store allows unauthenticated access or roles are overly permissive
...
4. **Pass if:** Retention policy is documented, enforced, and disposal is automated
...
3. **Pass if:** Complete audit trail exists for all data access events
...
3. **Pass if:** Federated governance framework is documented and enforced
...
4. **Pass if:** Cross-border data handling is documented and compliant
